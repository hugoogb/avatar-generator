# @avatar-generator/svelte

Svelte component for [`@avatar-generator`](https://github.com/hugoogb/avatar-generator) —
...
`svelte` and `@avatar-generator/core` are peer dependencies.
...
See the [Svelte guide](https://avatar-generator-two.vercel.app/guides/svelte/) for the full prop list.
